...
void linear_q3k_decode_w3a8(size_t      n_in,
                            size_t      n_out,
    ...
    linear_q3k_decode_w3a8_pre(n_in, n_out, scale_x, x_q8, w_q3k, y);
    safe_free((void **) &x_q8);
}
...
void linear_q3k_w3a8_prefill(
    ...
    linear_q3k_w3a8_prefill_pre(m, n_in, n_out, x_q8, scale_x, w_q3k, y);
    safe_free((void **) &x_q8);
