...
| Benchmark round (2026-07-14, post-rebase on main @17a06fa) | 1066 (spread 1019–1183) | 132.6 | 442 | full quality + perf pass after rebasing onto main (#102/#104 x86 work, x86 default-BACKENDS flip — no Vulkan code changes): decode reproduces to the tenth (132.6 vs 132.3), pp/E2E inside the known warm-clock spread. llama.cpp re-measured same day (pp 4678 / tg 153.4 / E2E ~678 — geist at 23% / 86% / 65% of the bar). MMLU-200 vulkan 0.520 (104/200) — IDENTICAL to the 07-06 round — vs cpu_x86 0.495 (99/200, was 0.490; the #102/#104 ULP-level CPU changes shifted one greedy trajectory; binomial sigma ~7, gate passed). Tooling 14/14 JSON + 14/14 function-calling. Protocol note: the "geist cpu_x86 (16T, the bar)" row above (909.3/71.1/271) did NOT reproduce with the documented reproduce command on this build (measured 478.8/42.3/156 with GEMM_PROVIDER=native) — the old bar likely came from a different GEMM provider/build config; re-pin it next round |
