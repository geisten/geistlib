...
[![Status](https://img.shields.io/badge/status-experimental%20(v0.6.0)-yellow.svg)](#status)
...
`geistlib` is **v0.6.0 — experimental**. It runs Gemma 4 (text + vision + audio) end
